            ...
            <div class="page-header float-right">
                <div class="page-title">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                            ...
                                            style="border-radius: 0 3px 3px 0; box-shadow: none;">Thêm mới hạng thẻ
                                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table id="myTable" class="display" style="min-width: 800px" >
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $card->name }}</td>
                        <td contenteditable data-card_id={{ $card->id }} class="card_edit">{{ number_format($card->total_money) }} đ</td>
                       <td>
                            {{-- @can('product delete') --}}
                            <a style="color: red; font-size: 20px;" href="{{ route('delete.card', $card->id) }}"><i class="ti-trash"></i></a>
                           {{--  @endcan --}}
                       </td>
                    </tr>
                   @endforeach
